...
## Project Structure
    ...
    ├── testapiautosettings_94255  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_94255`
...
2. Clone this repo and `cd testapiautosettings_94255`
